...
const FeaturedToolsSection = () => {
  ...
  const ToolCard = ({ icon: Icon, name, bgColor, iconBg }) => (
    <div className={`flex-shrink-0 rounded-2xl p-6 mr-6 w-60 border border-white/20 hover:border-white/40 hover:shadow-lg hover:shadow-black/5 transition-all duration-300 cursor-pointer group glass-effect`}>
...
.animate-infinite-scroll-right {
  animation: infinite-scroll-right 20s linear infinite;
  width: calc(264px * 10);
}
