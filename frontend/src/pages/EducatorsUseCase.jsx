...
import { ChevronRight, Clock, Film, Download, BookOpen, Users, Lightbulb, Presentation, Mail, RefreshCw, Zap } from "lucide-react";
...
const UseCase = ({ title, icon, description }) => {
  ...
  return (
    ...
    >
      <div className={`mb-3 transition-all duration-300 ${isHovered ? "text-white" : "text-orange-400"}`}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 max-w-md mx-auto">
            ...
            <a href='/features/summarizer'> <button className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-105 flex items-center mx-auto mb-3">
              Start Teaching Better
              <ChevronRight className="ml-2 h-5 w-5" />
            </button>
            <p className="text-sm text-gray-400">Better now than never.</p> </a>
          </div>
        </div>
      </div>
      {/*footer*/}
