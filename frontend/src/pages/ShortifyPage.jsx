        ...
        <div className="flex-1 p-10 overflow-auto">
          ...
          {activeTab === "home" && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                <div
                  key={id}
                  className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:shadow-md transition-shadow flex flex-col justify-between"
                >
                  <div>
                  ...
                  <div className="flex justify-center">
                    <a href={link}>
                      <button className="text-white bg-gradient-to-r from-blue-500 to-green-500 py-2 px-6 rounded-full hover:from-blue-400 hover:to-green-400">
                        {label}
                      </button>
                    </a>
                  </div>
          ...
          {activeTab === "shorts" && (
            <div className="space-y-6">
              ...
              <p className="text-gray-700 text-lg">
                Turn long YouTube videos into bite-sized Shorts that boost
                engagement and save editing time.
              </p>
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-2"> Use Case:</h3>
                <p className="text-gray-600">
                  Ideal for content creators who want to repurpose long-form
                  content into short videos for platforms like YouTube Shorts,
              ...
              <div className="bg-blue-100 border border-blue-200 rounded-lg p-6">
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700">
                  ...
                  <li>
                    Click <strong>"Generate Shorts"</strong>.
                  </li>
                  <li>
                    The system detects highlights and creates 15–60 sec clips.
                  </li>
                  <li>
                    You can preview, download, or directly post the clips.
                  </li>
                </ol>
              </div>
              <div className="flex justify-center">
                <a href="/features/shorts-generator">
                  <button className="mt-4 text-white bg-gradient-to-r from-blue-500 to-indigo-500 py-2.5 px-7 rounded-full hover:from-blue-400 hover:to-green-400">
                    Get Started
                  </button>
                </a>
              </div>
          ...
          {activeTab === "summarizer" && (
            <div className="space-y-6">
              ...
              <p className="text-gray-700 text-lg">
                Save hours by reading concise summaries of YouTube
                videos—perfect for research, learning, or reviews.
              </p>
              <div className="bg-purple-50 border border-purple-100 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-2"> Use Case:</h3>
                <p className="text-gray-600">
                  Great for students, researchers, and professionals who want to
                  extract value from long videos without watching them entirely.
                </p>
              </div>
              <div className="bg-purple-100 border border-purple-200 rounded-lg p-6">
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700">
                  ...
                  <li>
                    Click <strong>"Summarize Video"</strong>.
                  </li>
                  <li>
                    A detailed summary will be generated based on the video
                    transcript.
                  </li>
              ...
              <div className="flex justify-center">
                <a href="/features/summarizer">
                  <button className="mt-4 text-white bg-gradient-to-r from-purple-500 to-pink-500 py-2.5 px-7 rounded-full hover:from-purple-400 hover:to-pink-400">
                    Coming Soon
                  </button>
                </a>
              </div>
          ...
          {activeTab === "pdf" && (
            <div className="space-y-6">
              ...
              <p className="text-gray-700 text-lg">
                Summarize lengthy research papers, reports, or notes into
                digestible key points quickly.
              </p>
              <div className="bg-green-50 border border-green-100 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-2"> Use Case:</h3>
                <p className="text-gray-600">
                  Perfect for students, educators, and analysts to quickly
                  understand documents without reading every word.
                </p>
              </div>
              <div className="bg-green-100 border border-green-200 rounded-lg p-6">
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700">
                  ...
                  <li>
                    Click <strong>"Summarize PDF"</strong>.
                  </li>
              ...
              <div className="flex justify-center">
                <a href="/features/pdf-summarizer">
                  <button className="mt-4 text-white bg-gradient-to-r from-green-500 to-blue-500 py-2.5 px-7 rounded-full hover:from-green-400 hover:to-blue-400">
                    Coming Soon
                  </button>
                </a>
              </div>
