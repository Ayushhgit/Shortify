...
const roles = [
  { id: "frontend", name: "Frontend Developer", icon: "💻", color: "from-blue-500 to-purple-600" },
  { id: "backend", name: "Backend Developer", icon: "⚙️", color: "from-green-500 to-teal-600" },
  { id: "data", name: "Data Scientist", icon: "📊", color: "from-orange-500 to-red-600" },
  { id: "ai", name: "AI/ML Engineer", icon: "🧠", color: "from-purple-500 to-pink-600" },
  { id: "fullstack", name: "Full Stack Developer", icon: "🚀", color: "from-indigo-500 to-blue-600" },
  { id: "devops", name: "DevOps Engineer", icon: "☁️", color: "from-gray-500 to-slate-600" },
  { id: "pm", name: "Product Manager", icon: "📈", color: "from-emerald-500 to-green-600" },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Get instant, AI-driven insights to optimize your resume and land your dream job
            </p>
          </div>
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-center space-x-3 mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-white">Choose Your Target Role</h2>
                </div>
                <div className="relative max-w-md mx-auto">
                  ...
                  >
                    <option value="" className="bg-gray-900 text-white">-- Select a Role --</option>
                    {roles.map((role) => (
                ...
                {selectedRole && (
                  <div className="max-w-md mx-auto mt-6 p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-emerald-400/30 animate-fadeIn">
                    <div className="flex items-center space-x-4">
                      <div className={`text-3xl p-3 rounded-xl bg-gradient-to-r ${selectedRole.color}`}>
                        {selectedRole.icon}
                      </div>
                      <div>
                        <h3 className="text-lg font-semibold text-white">{selectedRole.name}</h3>
                        <p className="text-emerald-300 text-sm">Role selected successfully!</p>
                      </div>
                  ...
                  <div className="space-y-4">
                    {resumeFile ? (
                      <>
                        ...
                        <div>
                          <p className="text-green-300 font-semibold text-lg">File uploaded successfully!</p>
                      ...
                      <>
                        ...
                        <div>
                          <p className="text-white font-semibold text-lg">Drop your PDF resume here</p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-white font-semibold">{resumeFile.name}</span>
                  </div>
                </div>
              </div>
              <button
          ...
          {step === 3 && loading && (
            <div className="max-w-2xl mx-auto text-center space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-gray-300 text-lg">Our AI is examining your resume against industry standards...</p>
              </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-center space-x-3">
                        <div className={`w-4 h-4 rounded-full ${index < 2 ? 'bg-emerald-400' : index === 2 ? 'bg-emerald-400 animate-pulse' : 'bg-gray-600'}`}></div>
          ...
          {step === 4 && result && (
            <div className={`space-y-8 transition-all duration-1000 ${animateResult ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
              {/* Score Overview */}
              <div className="text-center space-y-6">
                ...
                <div className="max-w-2xl mx-auto">
                  <div className={`inline-flex items-center px-6 py-3 rounded-full font-semibold text-lg ${
                    result.score >= 80 ? 'bg-green-500/20 text-green-300 border border-green-500/30' :
                    result.score >= 60 ? 'bg-yellow-500/20 text-yellow-300 border border-yellow-500/30' :
              ...
              {(result.keywords || result.recommendedSkills) && (
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-purple-400/30">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-white">Skills Analysis</h3>
                  </div>
                  <div className="grid md:grid-cols-2 gap-8">
                    {result.keywords && (
                      <div>
                        <h4 className="text-lg font-semibold text-white mb-4">
                          Matched Skills {result.matchedSkills && result.totalSkills && `(${result.matchedSkills}/${result.totalSkills})`}
                        </h4>
                        <div className="flex flex-wrap gap-2">
                          {result.keywords.map((skill, index) => (
                            <span key={index} className="px-3 py-1 bg-emerald-500/20 text-emerald-300 rounded-full text-sm border border-emerald-500/30">
                              {skill}
                            </span>
                          ))}
                        </div>
                    ...
                    {result.recommendedSkills && (
                      <div>
                        <h4 className="text-lg font-semibold text-white mb-4">Recommended Skills</h4>
                        <div className="flex flex-wrap gap-2">
              ...
              <div className="flex justify-center space-x-4">
                <button
                  ...
                  className="px-8 py-3 bg-white/20 text-white rounded-xl font-semibold hover:bg-white/30 transition-all duration-300 border border-white/30"
                >
                  Analyze Another Resume
                </button>
                <button className="px-8 py-3 bg-gradient-to-r from-emerald-500 to-blue-500 text-white rounded-xl font-semibold hover:scale-105 transition-all duration-300">
                  <div className="flex items-center space-x-2">
                    <Rocket className="w-5 h-5" />
                    <span>Get Premium Insights</span>
                  </div>
                </button>
              </div>
            </div>
