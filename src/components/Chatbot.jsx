...
export default function Chatbot() {
  ...
  const handleSendMessage = async () => {
    ...
    // const response = await fetch('/api/chat', { method: 'POST', body: JSON.stringify({ message: inputValue }) });
    // const data = await response.json();
    // const aiReply = data.reply;

    // Example usage after API:
    // setMessages(prev => [...prev, { id: Date.now(), text: aiReply, sender: 'bot', time: ... }])
  };
