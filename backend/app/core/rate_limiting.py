...
SUBSCRIPTION_LIMITS: Dict[str, Dict[FeatureType, int]] = {
    "free": {
        ...
        FeatureType.PDF_SUMMARIZATION: 3,
        FeatureType.YT_SUMMARIZATION: 5,
        FeatureType.ARTICLE_SUMMARIZATION: 5,
        FeatureType.RESUME_ANALYSIS: 2,
        FeatureType.COVER_LETTER_GENERATION: 2,
        FeatureType.ASSIGNMENT_HELP: 1,
        FeatureType.RESEARCH_ASSISTANCE: 1,
    ...
    "pro": {
        ...
        FeatureType.YT_SUMMARIZATION: 15,
        FeatureType.ARTICLE_SUMMARIZATION: 15,
