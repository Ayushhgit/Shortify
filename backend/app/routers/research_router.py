...
from app.services.research_agent import run_research_agent, run_direct_research
import logging
...
async def run_agent(req: QueryRequest):
    ...
    try:
        ...
        logger.info(f"Received research query: {req.query[:100]}...")
        
        # Run the research agent (now handles all fallbacks internally)
        result = run_research_agent(req.query)
